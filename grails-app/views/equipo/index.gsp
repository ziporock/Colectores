		...
		<div id="list-equipo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="temperaturaAgua" title="${message(code: 'equipo.temperaturaAgua.label', default: 'Temperatura Agua')}" />
				...
				<g:each in="${equipoInstanceList}" status="i" var="equipoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${equipoInstance.id}">${fieldValue(bean: equipoInstance, field: "temperaturaAgua")}</g:link></td>

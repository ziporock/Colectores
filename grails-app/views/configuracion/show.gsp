	...
	<body>
		...
		<div id="show-configuracion" class="content scaffold-show" role="main">
			...
			<ol class="property-list configuracion">
				...
				<g:if test="${configuracionInstance?.ensayos}">
				<li class="fieldcontain">
					<span id="ensayos-label" class="property-label"><g:message code="configuracion.ensayos.label" default="Ensayos" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${configuracionInstance?.equipos}">
				<li class="fieldcontain">
					<span id="equipos-label" class="property-label"><g:message code="configuracion.equipos.label" default="Equipos" /></span>
